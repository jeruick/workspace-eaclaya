# com-chilipeppr-workspace-eaclaya
A ChiliPeppr Workspace eaclaya.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / eaclaya
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-eaclaya |
| Name                  | Workspace / eaclaya |
| Description           | A ChiliPeppr Workspace eaclaya. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/jeruick/workspace-eaclaya/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/eaclaya/workspace-eaclaya |
| Github URL            | http://github.com/jeruick/workspace-eaclaya |
| Test URL              | https://preview.c9users.io/eaclaya/workspace-eaclaya/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/jeruick/workspace-eaclaya/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-eaclaya"], // the id you gave your workspace
      function(myWorkspaceEaclaya) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / eaclaya just got loaded.", myWorkspaceEaclaya);
        myWorkspaceEaclaya.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-eaclaya"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / eaclaya"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace eaclaya."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/jeruick/workspace-eaclaya/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/eaclaya/workspace-eaclaya"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/jeruick/workspace-eaclaya"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-eaclaya-eaclaya.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
